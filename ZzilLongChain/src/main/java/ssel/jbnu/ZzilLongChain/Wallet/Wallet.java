	...
	public void generateKeyPair() {
	 ...
	 //returns balance and stores the UTXO's owned by this wallet in this.UTXOs
		public float getBalance() {
			float total = 0;	
	        for (Map.Entry<String, TransactionOutput> item: ZzilLongChain.UTXOs.entrySet()){
	    ...
	    //create array list of inputs
			...
			newTransaction.signature = newTransaction.DigitalSignature.generateSignature(privateKey, newTransaction.sender, newTransaction.reciepient, newTransaction.value);
